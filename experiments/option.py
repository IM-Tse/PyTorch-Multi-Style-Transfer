...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument("--log_file", default="train.log", help="File for log", type=str)
        # training args
        ...
        train_arg.add_argument("--style-folder", type=str, default="images/21styles/",
                               help="path to style-folder")
        train_arg.add_argument("--vgg-model-dir", type=str, default="models/vgg16",
                               help="directory for vgg, if model is not present in the directory it is downloaded")
        train_arg.add_argument("--save-model-dir", type=str, default="models/",
                               help="path to folder where trained model will be saved.")
        train_arg.add_argument("--check-model-path", type=str, default="models/checkpoint",
                               help="path to folder where checkpoint model will be saved")
        ...
        optim_arg.add_argument("--style-image", type=str, default="images/21styles/candy.jpg",
        ...
        optim_arg.add_argument("--vgg-model-dir", type=str, default="models/vgg16",
                               help="directory for vgg, if model is not present in the directory it is downloaded")
        ...
        eval_arg.add_argument("--content-image", type=str, required=True,
                              help="path to content image you want to stylize")
        eval_arg.add_argument("--style-image", type=str, default="images/21styles/candy.jpg",
                              help="path to style-image")
        ...
        eval_arg.add_argument("--cuda", type=int, default=1,
                              help="set it to 1 for running on GPU, 0 for CPU")
        eval_arg.add_argument("--vgg-model-dir", type=str, default="models/vgg16",
                              help="directory for vgg, if model is not present in the directory it is downloaded")
        ...
        demo_arg.add_argument("--style-folder", type=str, default="images/21styles/",
                              help="path to style-folder")
        demo_arg.add_argument("--style-size", type=int, default=256,
                              help="size of style-image, default is the original size of style image")
